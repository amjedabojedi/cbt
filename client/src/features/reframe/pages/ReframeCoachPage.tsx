        ...
        <div className="-mx-2 sm:-mx-4 bg-gradient-to-br from-slate-800 via-teal-900 to-teal-700 px-6 sm:px-10 pt-8 pb-10 relative overflow-hidden transition-all duration-300">
          ...
          <div className="max-w-5xl mx-auto relative">
              ...
              {showStats && (
                <div className="flex items-center gap-6 shrink-0 flex-wrap">
                  {[
                    ...
                    { value: tNum(avgScore), label: t("Avg Score"), color: "text-teal-300" },
            ...
            <div className="mt-6 bg-white/5 rounded-xl border border-white/10 p-4">
              ...
              <p className="text-[11px] text-teal-300/60 mt-1.5">{masteryFooter}</p>
            </div>
          </div>
        </div>
                ...
                <CardContent className="p-6">
                  {thoughtsLoading ? (
                    ...
                    <div className="text-center py-12">
                      <div className="mb-4 inline-flex items-center justify-center w-16 h-16 bg-teal-50 text-teal-700 rounded-full">
                      ...
                      {!isViewingClientData && (
                        <Button
                          ...
                          className="bg-teal-800 hover:bg-teal-700 text-white rounded-xl px-6 py-2.5 font-semibold transition-all duration-200"
                        >
