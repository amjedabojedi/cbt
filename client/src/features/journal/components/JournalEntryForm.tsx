...
export function JournalEntryForm({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent aria-describedby={undefined} className="max-w-xl p-0 rounded-2xl border-0 overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-purple-300/80 text-xs mt-0.5 font-medium">
                {isEditing ? "Update your thoughts and reflections" : "Capture your thoughts and feelings"}
              </p>
            </div>
          </div>
        </div>
