        ...
        <CardContent className="p-8">
          <div className="space-y-6">
            ...
            <div className="text-center space-y-4 py-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Practice Cognitive Reframing</h2>
            ...
            <div className="bg-gray-50 rounded-lg p-6 space-y-3">
              ...
              <ol className="space-y-2 text-sm text-gray-700">
                <li className="flex gap-3">
                  ...
                  <span><strong>Read scenarios</strong> - Review situations with automatic thoughts</span>
                </li>
                <li className="flex gap-3">
                ...
                <li className="flex gap-3">
                  ...
                  <span><strong>Get feedback</strong> - Learn why certain reframes are more effective</span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span><strong>View results</strong> - See your score, accuracy, and progress</span>
                </li>
              </ol>
            </div>
