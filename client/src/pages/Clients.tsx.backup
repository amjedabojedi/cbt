                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead>Stats Overview</TableHead>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem 
                                  ...
                                  onClick={() => {
                                    ...
                                    // Navigate to dashboard with this client's stats
                                    localStorage.setItem('viewingClientId', client.id.toString());
                                    localStorage.setItem('viewingClientName', client.name || client.username);
                                    setViewingClient(client.id, client.name || client.username);
            ...
            <DialogContent className="max-w-3xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2">
                  {/* Removed redundant tabs structure */}
...
// We now use the Heart component from Lucide, so this custom component is no longer needed
// Removed custom HeartIcon to avoid duplicate declarations
